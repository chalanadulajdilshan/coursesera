...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Create News - EasyTutor.lk</title>
                                            ...
                                            <div class="br">
                                                <div class="row">  
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                            <input type="text" class="form-control  datepicker" placeholder="Enter Date" id="date" name="date">
                                                        </div>
                                                    </div>  
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Short Description" id="short_description" name="short_description"  >
                                                        </div>
                                                    </div>  

                                                    <div class="col-sm-12"  > 
                                                        <label>News Image <b><span class="text-danger text-uppercase">Please use this image size ( 350px * 230px )</span></b></label>
