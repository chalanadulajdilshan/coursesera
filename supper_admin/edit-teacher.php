...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Teacher Teachers - EasyTutor.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Edit Teachers
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                                ...
                                                <div class="row">  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter Full Name" id="full_name" name="full_name" value="<?php echo $TEACHER->full_name ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>NIC Number</label>
                                                            <input type="text" class="form-control" placeholder="Enter NIC Number" id="nic_number" name="nic_number" value="<?php echo $TEACHER->nic_number ?>">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control  " placeholder="Enter Mobile Number" id="mobile_number" name="mobile_number" value="<?php echo $TEACHER->mobile_number ?>">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Email</label>
                                                            <input type="text" class="form-control  " placeholder="Enter Email Address" id="email" name="email" value="<?php echo $TEACHER->email ?>">
                                                        </div>
                                                    </div>  
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select2 form-control" id="district" >
                                                                ...
                                                                <?php
                                                                $CITY = new City($TEACHER->city);
                                                                $DISTRICT = new District(NULL);
                                                                foreach ($DISTRICT->all() as $district) {
                                                                    if ($CITY->district == $district['id']) {
                                                                        ?>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Address </label>
                                                            <input type="text" class="form-control" placeholder="Enter Address" id="address" name="address"  value="<?php echo $TEACHER->address ?>">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Subject </label>
                                                            <input type="text" class="form-control" placeholder="Enter Subject" id="subject" name="subject"  value="<?php echo $TEACHER->subject ?>">
                                                        </div>
                                                    </div>  
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Enter teacher login url" id="login_url_teacher" name="login_url_teacher"   value="<?php echo $TEACHER->login_url_teacher ?>">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Student Login URL</label>
                                                            <input type="text" class="form-control" placeholder="Enter student login url" id="login_url_student" name="login_url_student"   value="<?php echo $TEACHER->login_url_student ?>">
                                                        </div>
                                                    </div>  
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>User Name</label>
                                                            <input type="text" class="form-control" placeholder="Enter User Name" id="username" name="username"   value="<?php echo $TEACHER->username ?>">
                                                        </div>
                                                    </div> 
                                                    <div class="col-sm-12">
                                                        <div class="form-group">
                                                            <label>Password</label>
                                                            <input type="password" class="form-control"   id="password" name="password"   value="<?php echo $TEACHER->password ?>">
                                                        </div>
                                                    </div> 
                                                    <div class="col-sm-12"  > 
                                                        <label>Teacher Image <b><span class="text-danger text-uppercase">Please use this image size ( 255px * 300px )</span></b></label>
                                                        <div class="custom-file">
                                                            <input type="hidden" class="custom-file-input" id="image_name" value="<?php echo $TEACHER->image_name ?>">
                                                    ...
                                                    <div class="col-sm-12"  > 
                                                        <img src="../upload/teacher/<?php echo $TEACHER->image_name ?>"  class="mt-1   ">
                                                    ...
                                                    <div class="col-md-6  mt-10">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="checkbox checkbox-primary mt-1">
                                                                <input type="checkbox" id="agree"   name="is_active" value="1" value="1"   <?php
                                                    ...
                                                    <div class="col-sm-6"> 
                                                        ...
                                                        <input type="hidden"  value="<?php echo $TEACHER->image_name; ?>" name="oldImageName"/>
