...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage In Active Teachers - EasyTutor.lk</title>
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage In Active Teachers 
                                        </li>
                                    </ol>
                                </div>
                            </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table zero-configuration">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($TEACHER->getInActiveTeachers() as $key => $teachers) {
                                                            $key++;
                                                            ?>
