...
$(document).ready(function () {
    "use strict";
    if (0 < chatSidebarListWrapper.length)
        new PerfectScrollbar(".chat-sidebar-list-wrapper");
    if (0 < $(".chat-user-profile-scroll").length)
        new PerfectScrollbar(".chat-user-profile-scroll");
    if (0 < chatContainer.length)
        new PerfectScrollbar(".chat-container");
    if (0 < $(".chat-profile-content").length)
        new PerfectScrollbar(".chat-profile-content");
    chatSidebarProfileToggle.on("click", function () {
        ...
        $(".chat-sidebar-list-wrapper ul li").hasClass("active") && $(".chat-sidebar-list-wrapper ul li").removeClass("active"),
                ...
                $(".chat-sidebar-list-wrapper ul li").hasClass("active") ? (chatStart.addClass("d-none"), chatArea.removeClass("d-none")) : (chatStart.removeClass("d-none"), chatArea.addClass("d-none"));
    }),
        ...
        992 < $(window).width() && chatOverlay.hasClass("show") && chatOverlay.removeClass("show"),
                $(window).width() < 992 &&
                chatSidebarToggle.on("click", function () {
                    chatSidebar.addClass("show"), chatOverlay.addClass("show");
                }),
