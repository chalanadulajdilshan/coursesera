                        ...
                        <form id="form-data">
                            <div class="row">
                                <div class="col-md-6 col-md-push-3">  
                                    <div class="  border-1px " id="first_form" style="padding: 25px 25px 25px 25px !important;background-color: #fff !important;"  >
                                        <h3 class="mt-0 pt-5 text-center text-success font-weight-700" style="font-size: 32px;">SUCCESSFULLY..!</h3>
                                        <center>
