            ...
            <div class="row">
                <div class="col-md-8 blog-pull-right">
                    <div class="single-service">
                        <!--<img src="<?php echo URL; ?>public/images/services/lg3.jpg" alt="">-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="#">
                                    <div class="btn btn-rounded btn-primary col-sm-12 col-md-2 mt-0">
                                        Register Now
                                    </div>
                                </a>
                    ...
                    <div class="sidebar sidebar-left mt-sm-30">
                        <div class="widget">
                            ...
                            <div class="services-list">
                                ...
                                <a href="<?php echo URL; ?>course" style="color: blue;">See More..</a>
                            </div>
                        </div>
                        <!--                        <div class="widget">
                        ...
                        <div class="widget">
                            <h4 class="widget-title line-bottom">Success Stories</h4>
