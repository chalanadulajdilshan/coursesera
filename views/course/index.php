...
<div class="main-content">
    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="<?php echo URL; ?>public/images/bg/bg6.jpg">
        <div class="container pt-70 pb-20">
            <!-- Section Content -->
            <div class="section-content">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="title text-white text-center">Course List</h2>
                        ...
                        <div class="widget">
                            ...
                            <div class="latest-posts">
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a class="post-thumb" href="#"><img src="<?php echo URL; ?>public/images/services/s1.jpg" alt=""></a>
                                ...
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a class="post-thumb" href="#"><img src="<?php echo URL; ?>public/images/services/s3.jpg" alt=""></a>
                                    <div class="post-right">
                                ...
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a class="post-thumb" href="#"><img src="<?php echo URL; ?>public/images/services/s2.jpg" alt=""></a>
                                    <div class="post-right">
...
<!--                        <div class="widget">
                            ...
                            <div id="flickr-feed" class="clearfix">
                                 Flickr Link 
                                <script type="text/javascript" src="<?php echo URL; ?>public/http://www.flickr.com/badge_code_v2.gne?count=9&amp;display=latest&amp;size=s&amp;layout=x&amp;source=user&amp;user=52617155@N08">
                                </script>
                            </div>
                        </div>-->
                    </div>
