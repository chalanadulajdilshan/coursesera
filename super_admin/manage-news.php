...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Manage News - EasyTutor.lk</title>
    ...
    <body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns" data-layout="semi-dark-layout">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper col-12">
                                    <ol class="breadcrumb p-0 mb-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage News
                                        </li>
                                    </ol>
                                </div>
                            </div>
                    ...
                    <section id="dashboard-ecommerce">
                        <div class="row">
                            ...
                            foreach ($NEWS->all() as $news) {
                                ?>
                                <div class="col-md-3" id="div<?php echo $news['id'] ?>">
                                    <div class="card">
                                        <div class="card-content">
                                            <img class="card-img-top img-fluid" src="../upload/news/<?php echo $news['image_name'] ?>" alt="<?php echo $news['title'] ?>"  >
                                            <div class="card-body" style="padding: 10px;">  
                                                <h6 class=" text-left"><?php echo $news['title'] ?></h6>
                                                <a href="edit-news.php?id=<?php echo $news['id'] ?>" data-toggle="tooltip" data-placement="bottom" title="Edit" ><i class=" bx bx-edit-alt edit-btn"></i></a> | 
                                                <a href="#" class="delete-news"  data-id="<?php echo $news['id'] ?>"  data-toggle="tooltip" data-placement="bottom" title="Delete" ><i class="bx bxs-trash delete-btn"></i></a> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script src="plugin/sweetalert/sweetalert.min.js" type="text/javascript"></script>
        <script src="delete/js/news.js" type="text/javascript"></script>
